...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GASSExperienceDefinition)

#define LOCTEXT_NAMESPACE "GASSSystem"

UGASSExperienceDefinition::UGASSExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UGASSExperienceDefinition::IsDataValid(TArray<FText>& ValidationErrors)
{
...
void UGASSExperienceDefinition::UpdateAssetBundleData()
{
