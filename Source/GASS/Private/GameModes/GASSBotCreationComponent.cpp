...
#include "GameModes/GASSBotCreationComponent.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GASSBotCreationComponent)

UGASSBotCreationComponent::UGASSBotCreationComponent(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

//void UGASSBotCreationComponent::BeginPlay()
//{
//	Super::BeginPlay();
//
...
//	ExperienceComponent->CallOrRegister_OnExperienceLoaded_LowPriority(FOnGASSExperienceLoaded::FDelegate::CreateUObject(this, &ThisClass::OnExperienceLoaded));
//}
//
//void UGASSBotCreationComponent::OnExperienceLoaded(const UGASSExperienceDefinition* Experience)
//{
//#if WITH_SERVER_CODE
//	if (HasAuthority())
//	{
...
//#if WITH_SERVER_CODE
//
//void UGASSBotCreationComponent::ServerCreateBots()
//{
...
//	if (GIsEditor)
//	{
//		const UGASSDeveloperSettings* DeveloperSettings = GetDefault<UGASSDeveloperSettings>();
//		
...
//}
//
//FString UGASSBotCreationComponent::CreateBotName(int32 PlayerIndex)
//{
//	FString Result;
...
//}
//
//void UGASSBotCreationComponent::SpawnOneBot()
//{
...
//	{
//		AGASSGameMode* GameMode = GetGameMode<AGASSGameMode>();
//		check(GameMode);
//
...
//		{
//			if (UGASSPawnExtensionComponent* PawnExtComponent = NewController->GetPawn()->FindComponentByClass<UGASSPawnExtensionComponent>())
//			{
...
//}
//
//void UGASSBotCreationComponent::RemoveOneBot()
//{
...
//			{
//				if (UGASSHealthComponent* HealthComponent = UGASSHealthComponent::FindHealthComponent(ControlledPawn))
//				{
