...
#include "GASSGameplayCueManager.generated.h"
...
/**
 * UGASSGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UGASSGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UGASSGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UGASSGameplayCueManager* Get();
