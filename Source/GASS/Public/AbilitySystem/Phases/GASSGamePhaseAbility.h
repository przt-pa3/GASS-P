...
#include "GASSGamePhaseAbility.generated.h"

/**
 * UGASSGamePhaseAbility
 *
 * The base gameplay ability for any ability that is used to change the active game phase.
 */
UCLASS(Abstract, HideCategories = Input)
class UGASSGamePhaseAbility : public UGASSGameplayAbility
{
	GENERATED_BODY()

public:

	UGASSGamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "GASS|Game Phase")
