...
#include "GASSAbilityTagMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FGASSAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UGASSAbilityTagMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FGASSAbilityTagRelationship> AbilityTagRelationships;
