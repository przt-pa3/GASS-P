...
#include "GASSCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * UGASSCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class UGASSCameraMode_ThirdPerson : public UGASSCameraMode
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditDefaultsOnly, Category = "Collision")
		TArray<FGASSPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
