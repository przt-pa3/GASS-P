...
#include "GASSCosmeticAnimationTypes.generated.h"
...
struct FGASSAnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FGASSAnimLayerSelectionSet
{
	GENERATED_BODY()
	...
	TArray<FGASSAnimLayerSelectionEntry> LayerRules;
...
USTRUCT(BlueprintType)
struct FGASSAnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FGASSAnimBodyStyleSelectionSet
{
	GENERATED_BODY()
		
	// List of layer rules to apply, first one that matches will be used
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(TitleProperty=Mesh))
	TArray<FGASSAnimBodyStyleSelectionEntry> MeshRules;
