...
#include "GASSRangedWeaponInstance.generated.h"

class UPhysicalMaterial;

/**
 * UGASSRangedWeaponInstance
 *
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 */
UCLASS()
class UGASSRangedWeaponInstance : public UGASSWeaponInstance, public IGASSAbilitySourceInterface
{
	GENERATED_BODY()

public:
	UGASSRangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
public:
	...
	//~IGASSAbilitySourceInterface interface
	...
	//~End of IGASSAbilitySourceInterface interface
