...
#include "GASSGameFeaturePolicy.generated.h"
...
class UGASSGameFeaturePolicy : public UDefaultGameFeaturesProjectPolicies
{
	GENERATED_BODY()

public:
	GASS_API static UGASSGameFeaturePolicy& Get();

	UGASSGameFeaturePolicy(const FObjectInitializer& ObjectInitializer);
...
//// checked
//UCLASS()
//class UGASSGameFeature_HotfixManager : public UObject, public IGameFeatureStateChangeObserver
//{
//	GENERATED_BODY()
//
//public:
...
//// checked
UCLASS()
class UGASSGameFeature_AddGameplayCuePaths : public UObject, public IGameFeatureStateChangeObserver
{
	GENERATED_BODY()
